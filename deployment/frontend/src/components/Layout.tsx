...
const Layout: React.FC<LayoutProps> = ({ children }) => {
  ...
  const loadMenuItems = async () => {
    ...
    const defaultMenus = [
      ...
      { menu_key: 'topik-upload', menu_name: t('menu.topikUpload'), icon: 'Assessment', route: '/topik-scores-upload' }
    ];
  ...
  const handleLanguageChange = (
    ...
    if (newLanguage) {
      setLanguage(newLanguage as 'ko' | 'vi');
        ...
        <Toolbar>
          ...
          >
            ...
            <ToggleButton value="vi" sx={{ color: 'white' }}>
              {language === 'ko' ? 'Tiếng Việt' : 'Tiếng Việt'}
            </ToggleButton>
          </ToggleButtonGroup>
            ...
            <MenuItem disabled>
              <Typography variant="caption" color="textSecondary">
                {user?.role === 'admin' ? t('roles.admin') : 
                 user?.role === 'teacher' ? t('roles.teacher') : t('roles.koreanBranch')}
              </Typography>
            </MenuItem>
            <Divider />
